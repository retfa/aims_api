            ...
            if variable_Name in ['METROLOGY-COATINGWEIGHT','METROLOGY-COATINGWEIGHT-2SIGMA','METROLOGY-P21-MO1-SP','METROLOGY-P21-MO1-SP-2SIGMA']:
                ...
                try:
                    ...
                    with srv_SRVAIUPSPRA1['create_engine'][0].connect() as conn:
                        conn.execute(text("SET LOCK_TIMEOUT 20000"))  # 設定 20 秒超時
    ...
    def fetch(self, stime: str, etime: str, variable_Name: str, MachineName: str):  
        ...
        if (not df_PROCESS_BCDRY.empty) or (not df_PROCESS_SHAP.empty):
            ...
            target_series_gramg = {
                ...
                "style": {"color": "#0000ff"},
                "show": True,
                "points": [{"time": t.strftime("%Y-%m-%d %H:%M:%S"), "value": v} for t, v in zip(df_result["TIMETAG"], df_result['gramg'])]
            }
            ...
            target_series_speed = {
                ...
                "style": {"color": "#ff0000"},
                "show": True,
                "points": [{"time": t.strftime("%Y-%m-%d %H:%M:%S"), "value": v} for t, v in zip(df_result["TIMETAG"], df_result['speed'])]
            }                       
