...
class product_cost_details(Resource):
    ...
    def fetch(self, stime: str, etime: str, mname: str, Product_Category: str, Product_two_ptype: str, two_month: str, level: str):
        ...
        def Product_Cost_Details(stime,etime,mname,Product_Category,Product_two_ptype,df_Product_cost_schedule_Items_schema=None,NCR_Base_Paper=None):
            ...
            def material_data(etime,df_Equivalent_Output_Before_Apportionment):
                ...
                df_RMData = pd.read_excel(r'\\Srvafp1\Public\Document\日結相關資訊\實際成本單\會計提供\RMData_料號成本.xlsx',
                                          sheet_name=etime_sheet_name,skiprows=0,header=0)
...
#             df_grouped_2[['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h']] = df_grouped_2[['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h']].round(2)
            ...
            # 抓能源單價
            try:
                df_cost_energy = pd.read_excel(r'E:\AP\Api\dist\工費與能源資料_2025年.xlsx',
                                          sheet_name='能源單價',skiprows=0)                
            except:                             
                df_cost_energy = pd.read_excel(r'\\Srvafp1\Public\Document\日結相關資訊\實際成本單\會計提供\工費與能源資料_2025年.xlsx',
                                          sheet_name='能源單價',skiprows=0)
            ...
            try:  
                file_path = r'E:\AP\Api\dist\工費與能源資料_2025年.xlsx'
                
                with pd.ExcelFile(file_path) as xls:
                    first_sheet_name = xls.sheet_names[0]
                    df_cost_sharing_raw = pd.read_excel(xls, sheet_name=first_sheet_name, skiprows=1)             
            except:                    
                file_path = r'\\Srvafp1\Public\Document\日結相關資訊\實際成本單\會計提供\工費與能源資料_2025年.xlsx'
...
class product_cost_equivalent(Resource):
    def __init__(self, servers):
        self.servers = servers     
...
class monthly_equivalent_production(Resource):
    def __init__(self, servers):
        self.servers = servers    
...
class monthly_ERP_inventory(Resource):
    def __init__(self, servers):
        self.servers = servers 
...
class monthly_yield_rate(Resource):
    def __init__(self, servers):
        self.servers = servers     
...
class End_work_in_process(Resource):
    def __init__(self, servers):
        self.servers = servers     
...
class monthly_fixed_fee(Resource):
    def __init__(self, servers):
        self.servers = servers     
...
class monthly_energy_usage(Resource):
    def __init__(self, servers):
        self.servers = servers     
...
class monthly_Cost_sheet(Resource):
    def __init__(self, servers):
        self.servers = servers     
