            ...
            with srv_SRVAD1['create_engine'][0].connect() as conn:
             ...
             (
                    select 
                        ...
                        CASE WHEN ptype IN ('KL00','SL00','SL0C') THEN '格拉新' ELSE '1' END AS IS_KL
                    from (
              ...
              SELECT t.bdate,t.mname,t.ptype,t.tl,t.pht,
                  CASE WHEN (SELECT COUNT(*) FROM raw_data WHERE ptype IN ('SL00','KL00','SL0C')) = 1 and t.IS_KL = '格拉新' AND n.weigh>ISNULL(m.weigh,0) THEN n.weigh ELSE m.weigh END as s5,
                  t.s6
                FROM raw_data t
                LEFT JOIN (
